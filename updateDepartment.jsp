                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group" id="ea_email_container">
                          <div id="eaEmailDropdown">
                            ...
                            <select id="eaemail" name="eaemail" class="form-control filter-multi-select" multiple>
                            </select>
                          </div>
                          <br>
                          <div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group" id="hod_email_container">
                          <div id="hodEmailDropdown">
                            ...
                            <select id="hodemail" name="hodemail" class="form-control filter-multi-select" multiple>
                            </select>
                          </div>
                          <br>
                          <div>

                                  ...
                                  <div class="d-flex ">
                                      <div class="input-group ">
                                          <input type="text" class="form-control column_filter"
                                              ...
                                              aria-describedby="button-addon2" id="emailname">
                                          <div class="input-group-append" id="search">
                                              <button class="btn btn-primary" type="button" id="emailadd">Add Email</button>
                                          </div>
                                      </div>
                                  </div>
                              </td>
                              ...
                              <td class=" col-12 ">
                                  <div class="d-flex ">
                                      <div class="input-group ">
                                          <input type="text" class="form-control column_filter"
                                              placeholder="Email" aria-label="Admin Theme"
                                              aria-describedby="button-addon2" id="emailname2">
                                          <div class="input-group-append" id="search">
                                              <button class="btn btn-primary" type="button" id="emailadd2">
                                                  Add Email</button>
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <div class="form-group"><label>HOD Name*</label> <input type="text"
                                                  placeholder="HOD Name" class="form-control" id="name"></div>

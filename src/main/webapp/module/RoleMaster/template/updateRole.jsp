                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group"><label>Role Code*</label> <input type="text" placeholder="Role Code"
                            class="form-control" required="" maxlength="10" id="form6Example1"></div>

                      </div>
                      <div class="col-2"></div>
                      <div class="col-md-4">
                        <div class="form-group"><label>Role Description*</label><input type="address" required=""
                            maxlength="12" id="form6Example5" placeholder="Role Description" class="form-control"></div>

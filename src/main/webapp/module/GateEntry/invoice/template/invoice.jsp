                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2">
                                <a class="btn btn-primary" href="../template/addInvoice.jsp"><i class="fa fa-plus"> </i> Add
                                    Invoice</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                ...
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone">Gate ID</th>
                                    <th class="text-left" data-hide="phone">In time</th>
                                    <th class="text-left" data-hide="phone,tablet">Out time</th>
                                    <th class="text-left" data-hide="phone">Bill to</th>
                                    <th class="text-left" data-hide="phone">Ship to</th>

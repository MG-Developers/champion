...
<body>
    ...
    <div id="wrapper">
                                            ...
                                            <form action="" id="qa_result">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3">
                                                            <div class="form-group"><label>Accept
                                                                </label> <input type="number" id="accept"
                                                                    class="form-control" style="font-weight: bold;">
                                                            </div>
                                                        </div>
                                                        <div class="col-3">
                                                            <div class="form-group"><label>Reject
                                                                </label> <input type="number" id="reject"
                                                                    class="form-control" style="font-weight: bold;">
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="form-group"><label>In Review
                                                                </label> <input type="number" id="in_review"
                                                                    class="form-control" style="font-weight: bold;">
                                                            </div>
                                                        </div>
                                                        <div class="col-1"></div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-1"></div>
                                                        <div class="col-11 ">
                                                            <input type="button" class="btn btn-primary qa_submit"
        ...
        <div class="wrapper wrapper-content  ">
            <form id="formABC" action="#" id="invoice_form">
                <div class="row">
                    <div class="col-sm-8">
                        <div class="ibox ">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        var Business = data.fs_DATABROWSE_F43121.data.gridData.rowset;
                ...
                $("#Dtable").on("click", ".action", function () {
                    ...
                    var disab = this;
                    function dis() {
                        $(disab).css("display", "none")
                    }
                    var q = row[4];
                    $(".qa_submit").click(function (e) {

                        var accept = $("#accept").val()
                        var reject = $("#reject").val()
                        var in_review = $("#reject").val()

                        let total = Number((accept)) + Number((reject)) + Number((in_review));

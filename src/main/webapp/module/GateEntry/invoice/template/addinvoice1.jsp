                                ...
                                <div class="col-12">
                                    <div class="panel panel-primary">
                                     ...
                                     <div class="input-group col p-0"> 
                                        <label class="col-3 col-form-label p-0">Company Code</label>   
                                    ...
                                    <br> <div class="input-group col p-0"> 
                                        <label class="col-3 col-form-label p-0">Business Unit</label>   
                                        <input type="text" class="form-control input_size" required=""
                                             aria-label="Admin Theme"
                                        ...
                                        <div class=" input-group-append">
                                            <button type="button" id="modeldata" class="btn btn-secondary select"
                                                ...
                                                <div class="col-6 b-r" id="form1">
                                                    ...
                                                    <div class="input-group col p-0"> 
                                                        <label class="col-3 col-form-label p-0">Doc. Company</label>   
                                                        <input type="text" class=" form-control input_size" required=""
                                                             aria-label="Admin Theme"
                                                    ...
                                                    <br><div class="input-group col p-0"> 
                                                        <label class="col-3 col-form-label p-0">State</label>   
                                                        <input type="text" class=" form-control input_size" required=""
                                                             aria-label="Admin Theme"
                                ...
                                <div class="col-12">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6 b-r" id="form3">
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-9"><input type="text" class="form-control input_size"
                                                ...
                                                <div class="form-group row"><label
                                                    class="col-3 col-form-label">Gate No.</label>
                                                <div class="col-9"><input type="text" class="form-control input_size"
                                                        required="" id="gate_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-9"><input type="text" readonly class="form-control input_size"
                                     ...
                                     <div class="input-group col p-0"> 
                                        <label class="col-3 col-form-label p-0">Vendor code</label>
                                           
                                   
                                        <input type="text" class=" col-9 form-control input_size" required=""
                                             aria-label="Admin Theme"
                                            ...
                                            <button type="button" id="modeldata" class="btn btn-secondary select"
                                                ...
                                                <div class="col-6" id="form4">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-9"><input type="date" class="form-control input_size "
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-9"><input type="text" class="form-control input_size" readonly
                                                            ...
                                                            <div class="col-4 b-r p-0 ">
                                                                <div class="d-flex">
                                                                    <div class="form-group col-6">
                                                                        ...
                                                                        <input type="text" class="textbox" id="purchase_order" placeholder="PO">
                                                                    </div>
                                                                    
                                                                    <div class="form-group col-6">
                                                                        <label class="control-label">Purchase Order Type</label>
                                                                        <input type="text" class="textbox" id="purchase_type" placeholder="PO Type">
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <table class="table table-bordered" id="tab_logic">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr id="addr0">
                                                                                        ...
                                                                                        <!-- <td><input type="text" class="form-control input_size one" required=""  
                                                                                            readonly value=""></td> -->
                                                                                        
                                                                                        <td><input type="text" class="form-control input_size po" required="" 
                                                                                            readonly value="">
                                                                                            
                                                                                        </td>
                                                                                        <td><input type="text" class="form-control input_size line_num" required="" 
                                                                                            readonly id="line_num" value="">
                                                                                            
                                                                                        </td>
                                                                                        <td><input type="text" class="form-control input_size details_status" required="" 
                                                                                readonly id="details_status">
                                                                                            
                                                                                        </td>
                                                                                        <td><input type="text" id="details_gate_id" required=""
                                                                                            readonly class="form-control input_size details_gate_id">
                                        ...
                                        <div class="p-0">
                                            ...
                                            <div class="tabs-container ">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li><a class="nav-link" id="data1" data-toggle="tab" href="#tab-2">GRN</a></li>
                                                                    ...
                                                                    <div class="row clearfix">
                                                                        <div class="">
                                                                            <table class="table table-bordered" id="tab_logicc">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th class="text-center"> PO No.
                                                                                        </th>
                                                                                        <th class="text-center"> Item</th>
                                                                                        <th class="text-center"> Quantity
                                                                                        </th>
                                                                                        <th class="text-center"> Currency
                                                                                        </th>
...
>>>>>>> 73a7bf8c6b1a60cbd64ca33a3d9514f4ee503f6b
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    <tr id="addrr0">
                                                                                        <td><input type="text" 
                                                                                            readonly class="form-control input_size onee" value="">
                                                                                        </td>
                                                                                        <td><input type="text" readonly class="form-control input_size line_numm" id="line_num"></td>
                                                                                        <td><input type="text" 
                                                                                            readonly class="form-control input_size details_statuss" id="details_status">
                                                                                        </td>
                                                                                        <td><input type="text" 
                                                                                            readonly
                                                                                            id="details_gate_id" class="form-control input_size currency">
                                                                                        </td>
                                                                                        <td><input type="text" id="item_code" 
                                                                                            readonly
                                                                                            class="form-control input_size unit_code">
                                                                                        </td>
                                                                                        <td><input type="text" id="hsn_code" 
                                                                                            readonly
                                                                                            class="form-control input_size amount">
                                                                                        </td>
<<<<<<< HEAD
...
=======
                                                                                ...
                                                                                class="btn btn-sm btn-danger border p-0 w-100 delete_rows">
                                                                                X </button></td>
                                                                                        <!-- <td><input type="text" id="quantity" class="form-control input_size quantity">
                                                                                        </td>
                                                                                        <td><input type="text" id="uom" class="form-control input_size uom">
                                                                                        </td>
                                                                                        <td><input type="text" id="rate" class="form-control input_size rate">
                                                                                        </td>
                                                                                        <td><input type="text" id="amount" class="form-control input_size amount">
                                                                                        </td> -->
>>>>>>> 73a7bf8c6b1a60cbd64ca33a3d9514f4ee503f6b
                                                                                    </tr>
                                                                                    <tr id="addrr1"></tr>
                                                                    ...
                                                                    <div class="row clearfix">
<<<<<<< HEAD
                                                                        <input readonly="" type="button" id="add_roww" class="btn btn-default pull-left border float-right " value="Add row">&nbsp;
                                                                        <input readonly="" type="button" id="delete_roww" class="pull-right btn btn-default border float-right " value="Delete row">
=======
                                                                        <!-- <div class=" float-right"> -->
                                                                        <input readonly="" type="button" id="add_roww" class="btn btn-default pull-left border float-right invisible" value="Add row">&nbsp;
                                                                        <input readonly="" type="button" id="delete_roww" class="pull-right btn btn-default border float-right invisible" value="Delete row">
                                                                        <!-- </div> -->
>>>>>>> 73a7bf8c6b1a60cbd64ca33a3d9514f4ee503f6b
                                                                    </div>
                                                                </div>
    ...
    <div class="col-12">
        <div class="panel panel-primary ">
            ...
            <div class="panel-body">
                    ...
                    <input type="button" class="btn col-6  border btn-secondary" value="Create GRN">
    ...
    <div class="col-12">
        <div class="panel panel-primary ">
            ...
            <div class="panel-body d-flex">
                    ...
                    <input type="button"  class="btn col-sm-6 btn-success border" value="Submit">
                ...
                $.ajax ({
                        ...
                        $("#fetch_btn").click(() => {
                                    ...
                                    success: function (data) {
                                        ...
                                        // console.log(data);
                                        let count = $("#tab_logicc tr").length - 3
                                        
                                        var Purchase_order = $("#purchase_order").val();

                                        
                                        if (arr.includes(Purchase_order) == false && data.amount != 0) {
                                            ...
                                            // for(var i = 0 ; i < data.po_details.length ;  i++)
                                            {
                                                ...
                                                let item_code = $(".unit_code")[i];
                                                let hsn_code = $(".amount")[i];
                                               


                                                $(one).val(data.po_details[j].order_number)
                                                $(line).val(data.po_details[j].item_number)
                                                $(status).val(data.po_details[j].quantity_ordered)
                                                $(gate_id).val(data.po_details[j].currency_code)
                                                $(item_code).val(data.po_details[j].unit_cost);
                                                $(hsn_code).val(data.po_details[j].extended_price);

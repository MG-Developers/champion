                        ...
                        <div class="controls">
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group"><label>Password*</label> <input type="password" placeholder="Role Code" class="form-control" required="" maxlength="12 " id="jdePassword"></div>
                              <div class="form-group"><label for="accessories">type*</label> <br><select name="Type" id="type" placeholder="Type"><option value = "JDE"> JDE</option><option value = "3P"> 3P</option></select></div>
                            </div>
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              ...
                              <div class="form-group"><label for="accessories">Env*</label> <br><select name="Env" id="env" placeholder="Environment"><option value = "Test"> Test</option><option value = "PD"> PD</option><option value = "PY"> PY</option></select>
                            </div>
                            </div>
